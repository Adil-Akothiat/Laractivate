        ...
        <div className="flex flex-col items-center text-center gap-5">
            ...
            <div>
                ...
                <p className="text-sm text-base-content/50 mt-1 max-w-sm">
                    Your account is now protected. You'll be asked for a
            ...
            {/* Recovery codes — always shown here since this is the first-and-only time */}
            {recoveryCodes.length > 0 && (
                <div className="w-full text-left">
                    ...
                    <p className="text-xs text-base-content/50 mb-3">
                        ...
                        authenticator. Each code works only once — store them
                        somewhere safe before closing this window.
                    </p>
