...
const headers = {
  ...
  password: {
    title: "Password",
    description:
      "Manage devices logged into your account. If you don't recognise a session, revoke it immediately to secure your account.",
  ...
  billing: {
    ...
    description:
      "View your billing history and download invoices for your records.",
